...
def list_responses(
    ...
    return ResponseService.get_form_responses(db, form_id, current_user)
...
def get_response_detail(
    ...
    return ResponseService.get_response_detail(db, form_id, response_id, current_user)
...
def get_form_statistics(
    ...
    return ResponseService.get_form_statistics(db, form_id, current_user)
